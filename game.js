import Portada from './src/escenarios/portada.js';
import Cuadricula from './src/escenarios/cuadricula.js';
import Menu from './src/escenarios/menu.js';
import Cronometro from './src/escenarios/cronometro.js';    
...
function preload() {
    this.load.image('fondo_portada', './public/assets/fondo_portada.png');
    this.load.image('boton_menu', './public/assets/boton_menu.png');
    this.load.image('boton_portada', './public/assets/boton_portada.png');
    this.load.json('palabrasData', './public/assets/palabras.json');
    this.load.image('fondo_juego', './public/assets/fondo_juego.png');
    this.load.audio('musica_fondo', './public/assets/musica_fondo.mp3');
    this.load.audio('click_tecla', './public/assets/click_tecla.mp3');
    this.load.audio('musica_de_victoria', './public/assets/musica_de_victoria.mp3');
    this.load.audio("click_verificar", './public/assets/click_verificar.mp3');
}
